...
REQUIRED = [
    ...
    "content/salvage/scrap_fragment.tres",
    "content/salvage/service_scrap.tres",
    "content/salvage/sensor_pod.tres",
    "content/salvage/satellite_panel.tres",
    "content/salvage/dense_composite.tres",
