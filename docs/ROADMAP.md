...
1. **Project Bootstrap + Web CI** — current branch/PR.
2. **Reusable Core Foundation** — lifecycle, input, save, settings, audio, platform service, build info, router.
...
12. **Polish + Retention** — discovery/rare feedback, satisfying VFX, scanner audio, transitions, balance/polish.
